          ...
          <div className="UiContentWrapper">
            ...
            <div className="UiSectionSubtitle">
              ...
              <ol>
                ...
                <li>
                  Install the app to your workspace to get a bot token (starts with{" "}
                  <code>xoxb-</code>).
                </li>
              ...
              <div className="UiSectionSubtitle" style={{ marginTop: 10 }}>
                <ol>
                  ...
                  <li>
                    ...
                    <strong>OAuth &amp; Permissions</strong> → add bot scopes (use the Manifest
                    below) → <strong>Install to Workspace</strong> → copy{" "}
              ...
              {groupPolicy === "allowlist" ? (
                <div style={{ marginTop: 10 }}>
                  ...
                  <div className="UiSectionSubtitle" style={{ marginTop: 8 }}>
                    Tip: unresolved channel names are kept as typed and resolved later when
                    possible.
                  </div>
                </div>
              ) : null}
